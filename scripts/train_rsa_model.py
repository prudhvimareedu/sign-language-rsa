...
def main():
    ...
    selected_indices = rsa_data["selected_indices"]

    print()
    print("Original features:", X_train.shape[1])
    print("RSA selected features:", len(selected_indices))
    ...
    # Train Random Forest
    print()
    print("Training RSA-selected Random Forest...")
